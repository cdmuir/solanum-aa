# Something with looking at parameters
...
s1 = fit_aa1$summary(c( "b0_log_sigma_resid", "b_log_sigma_resid_S", "rho_resid", "b0_aa",
...
s2 = fit_aa2$summary(c( "b0_log_sigma_resid", "b_log_sigma_resid_S", "rho_resid", "b0_aa",
                   "b_aa_light_intensity_2000",
                   "b_aa_light_treatment_high",
                   "b_aa_2000_high",
                   "rhosq_aa_acc", "etasq_aa_acc",
...
b0_log_sigma_resid = s1[s1$variable == "b0_log_sigma_resid",]$median
b_log_sigma_resid_S = s1[s1$variable == "b_log_sigma_resid_S",]$median
S = seq(0, 6, 0.1)
plot(S, exp(b0_log_sigma_resid + (6 - S) * b_log_sigma_resid_S))
