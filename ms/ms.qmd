...
The raw data set consisted of `r n_rh_curve_raw` \agcurve{} curves with an average of `r n_points_per_rh_curves_raw`. Manual curation of a data set this size in a principled, consistent manner is not feasible. Therefore, we automated data cleaning using custom *R* scripts. Cleaning is divided into six sequential steps \autoref{tbl-cleaning}.
