...
- warmup and sampling iterations were chosen so that parameter ESS > 1000 and  $\hat{R} < 1.01$ [@gelman_inference_1992] and the effective sample size (ESS) was greater than $10^3$.
