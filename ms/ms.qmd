...
$$A = \beta_0 + \beta_1 \text{log}(g_\text{sw}) + \beta_2 \text{log}(g_\text{sw}) ^ 2 + \epsilon$$
...
where $\text{min(log(}g_\text{sw}))$ and $\text{max(log(}g_\text{sw}))$ are the minumum and maximum values of $\text{log(}g_\text{sw})$ where amphi and pseudohypo curves overlap. \Aamphi{} is calculated from parameter estimates $\theta_\text{amphi} \in \{\beta_{0,\text{amphi}}, \beta_{1,\text{amphi}}, \beta_{2,\text{amphi}}\}$; \Ahypo{} is calculated from parameter estimates $\theta_\text{hypo} \in \{\beta_{0,\text{hypo}}, \beta_{1,\text{hypo}}, \beta_{2,\text{hypo}}\}$
