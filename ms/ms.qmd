...
aa_mean_range = df_aa_pred1 |>
  ...
  mutate(x = sprintf(
    "%.3f (range: %.3f–%.3f; %.0f of 29 accessions significant)",
    aa,
    min,
    max,
    n_signif
