...
curves overlap. We used the following equation to estimate \aax{} for
the \(k^{\text{th}}\) leaf at light intensity \(l\) in accession \(m\):
...
light intensity, and accession to set \(\Theta_2\) indexed by \agcurve{}
curve.
