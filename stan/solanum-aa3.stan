...
model {
  ...
  // priors ----
    ...
    Sigma_aa_light_intensity_2000_acc = cov_GPL1(Dmat,
      etasq_aa_light_intensity_2000_acc, rhosq_aa_light_intensity_2000_acc, 0);
    b_aa_light_intensity_2000_acc ~ multi_normal(rep_vector(0.0, n_acc),
  ...
  aa_acc = b0_aa + b_aa_acc + b_aa_light_intensity_2000 +
    b_aa_light_intensity_2000_acc;
