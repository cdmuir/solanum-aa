...
# m = cmdstan_model("solanum-aa5.stan")
stan_code = read_lines("solanum-aa5.stan") |> paste(collapse = "\n")

chkpt_path = paste0("chkpt_folder_aa5_", args[1])
