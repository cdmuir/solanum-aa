...
# m = cmdstan_model("solanum-aa2.stan")
stan_code = read_lines("solanum-aa2.stan") |> paste(collapse = "\n")

chkpt_path = paste0("chkpt_folder_aa2_", args[1])
...
write_rds(draws, paste0("draws_aa2_", args[1], ".rds"))
